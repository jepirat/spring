...
public class MainApp {
    public static void main(String[] args) {
        ...
        userService.add(new User("User3", "LastName3", "user3@mail.ru" , new Car(2432654, "Запорожец")));
        ...
        System.out.println(userService.getUserByModelAndSeries("Запорожец", 2432654).getCar());
        context.close();
    }
}
